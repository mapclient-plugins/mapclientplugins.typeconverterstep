...
class TypeConverterStep(WorkflowStepMountPoint):
    '''
    ...
    def __init__(self, location):
        ...
        self._config['Input Port Type'] = 'http://physiomeproject.org/workflow/1.0/rdf-schema#sometype'
        self._config['Output Port Type'] = 'http://physiomeproject.org/workflow/1.0/rdf-schema#someothertype'
