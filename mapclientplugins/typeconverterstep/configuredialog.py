...
class ConfigureDialog(QtWidgets.QDialog):
    ...
    def _makeConnections(self):
        ...
        self._ui.lineEditInputPortType.textChanged.connect(self.validate)
        self._ui.lineEditOutputPortType.textChanged.connect(self.validate)
    ...
    def validate(self):
        ...
        return valid and input_port_type_valid and output_port_type_valid
    ...
    def getConfig(self):
        ...
        config['Input Port Type'] = self._ui.lineEditInputPortType.text()
        config['Output Port Type'] = self._ui.lineEditOutputPortType.text()
        return config
